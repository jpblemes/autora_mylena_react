const books = [
  {
    ...
    extra:
      "A Ladra de Dois Mundos é o primeiro livro de uma trilogia de fantasia New Adult",
    description:
    ...
    wattpadurl: "",
    amazonurl:
      "https://www.amazon.com.br/Ladra-Dois-Mundos-crime-prestes-ebook/dp/B07Z235ZND",
    readerssummary: true,
    skooburl: "https://www.skoob.com.br/share/book/990387/991908",
    pinteresturl: "https://pin.it/Q76uuKA",
    spotfyurl:
      "https://open.spotify.com/playlist/4jFegjczw6ipB3Xjg41cg9?si=8-Piq8LkSAu3wi4CgLopjw",
  },
  {
    id: 2,
    ...
    extra:
      "A Rebelde de Dois Mundos é o segundo livro da trilogia de A Ladra de Dois Mundos",
    description:
    ...
    wattpadurl: "",
    amazonurl:
      "https://www.amazon.com.br/Rebelde-Dois-Mundos-convencida-destino-ebook/dp/B08P94FNF3",
    readerssummary: true,
  ...
  },
  {
    ...
    description:
      "Nada é tão ruim que não possa ser piorado. Foi o que Nara descobriu após receber a notícia que alterou o curso do seu destino. Ela precisava aprender, e rápido, a como dar aulas de física para alunos do último ano do ensino médio. Francis logo de cara deixa claro que será a pedra em seu caminho. Agora basta Nara descobrir o que é mais importante para ela: a vida profissional ou o campo magnético do Francis que a envolve a cada vez que o acaso os une.",
    summary:
      "Nada é tão ruim que não possa ser piorado. Foi o que Nara descobriu após receber a notícia que alterou o curso do seu destino. Ela precisava aprender, e rápido, a como dar aulas de física para alunos do último ano do ensino médio. Francis logo de cara deixa claro que será a pedra em seu caminho. Agora basta Nara descobrir o que é mais importante para ela: a vida profissional ou o campo magnético do Francis que a envolve a cada vez que o acaso os une.",
    wattpadurl:
      "https://www.wattpad.com/story/209399367-as-leis-do-acaso-um-conto-de-amor",
    amazonurl:
      "https://www.amazon.com.br/As-Leis-Acaso-Conto-Amor-ebook/dp/B087ZSCNBG",
    readerssummary: true,
