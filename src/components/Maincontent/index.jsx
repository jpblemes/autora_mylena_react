            ...
            <div>
              ...
              <div style={textstyle}>
                <p style={{ color: "#F8F8FF" }}>
                  Uma bela de uma Ladra convencida teve o seu destino roubado de
                  suas mãos.
                </p>
                <p style={{ color: "#F8F8FF" }}>
                  Áquila não é quem diz ser e Isabelle não é quem pensou que
                  fosse.
                </p>
                <p style={{ color: "#F8F8FF" }}>
                  Nessa luta de opostos, quem irá vencer: A honra ou o amor?
                </p>
              </div>
              <br />
              <div
                style={{ backgroundColor: "#cbbce6" }}
